...
<?php
    ...
    define('TITLE',"Dashboard| SolveIt");
            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="forum" role="tabpanel" aria-labelledby="forum-tab">
                                ...
                                <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
                                    <img class="mr-3" src="img/100.png" alt="" width="48" height="48">
                                  <div class="lh-100">
                                            ...
                                            while ($row = mysqli_fetch_assoc($result))
                                            {
                                                echo '<div class="col-md-6">
                                                        ...
                                                        <img class="card-img-left flex-auto d-none d-lg-block blogindex-cover" 
                                                                src="img/forum-cover1.png" alt="Card image cap">
                                                                </a>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            echo '<a href="poll.php?poll='.$row['id'].'">
                                                <div class="media text-muted pt-3">
                                                    <img src="img/poll-cover1.png" alt="" class="mr-2 rounded div-img poll-img">
                    ...
                    <div class="col-sm-2">
                        ...
                        <a href="forum.php" class="btn btn-warning btn-lg btn-block">SolveIt Forum</a>
                        <!-- <a href="hub.php" class="btn btn-secondary btn-lg btn-block">SolveIt Hub</a> -->
                        <br>
