                            ...
                            do
                            {
                                echo '<div class="col-sm-4" style="padding-bottom: 30px;">
                                        <div class="card user-blogs">
                                            ...
                                            <img class="card-img-top" src="img/forum-cover1.png" alt="Card image cap">
                                            <div class="card-block p-2">
                            ...
                            {   
                                echo '<div class="col-sm-4" style="padding-bottom: 30px;">
                                        <div class="card user-blogs">
                                            ...
                                            <img class="card-img-top" src="img/poll-cover1.png" alt="Card image cap">
                                            <div class="card-block p-2">
